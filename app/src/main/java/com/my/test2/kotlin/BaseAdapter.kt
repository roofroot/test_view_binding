...
abstract class BaseAdapter<T, B : ViewBinding?> :
    ...
    var onItemClick: com.dsf.vms.base.BaseAdapter.OnItemClick? = null
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): com.dsf.vms.base.BaseAdapter.ViewHolder<B> {
    ...
    protected abstract fun onBindHolder(
        holder: com.dsf.vms.base.BaseAdapter.ViewHolder<B>?,
        position: Int
    )
